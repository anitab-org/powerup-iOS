...
class StorySequencePlayerUnitTests: XCTestCase {
    ...
    /**
     Test all steps described in StorySequences() to ensure there are no errors in the dataset. The dataset is being generated by parsing StorySequences.json, which is created externally using the web tool PowerUp Story Designer.
