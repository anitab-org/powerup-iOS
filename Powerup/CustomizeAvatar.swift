...
class CustomizeAvatar: UIViewController {
    ...
    var hair = ["hair2", "hair3", "hair4", "hair5", "hair6", "hair7", "hair8", "hair9", "hair10", "hair11","hair12",""]
    var haircount = 0
    var hairtotal = 12
    @IBOutlet weak var clothesview: UIImageView!
    var clothes = ["cloth1", "cloth2", "cloth3", "cloth4", "cloth5", "cloth6", "cloth7", "cloth8", "cloth9","cloth10","cloth11"]
    var clothescount = 0
    var clothestotal = 11
