...
extension AboutViewController {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: CollapsableTableViewCell = tableView.dequeueReusableCell(withIdentifier: "cell") as? CollapsableTableViewCell ?? CollapsableTableViewCell(style: .default, reuseIdentifier: "cell")
